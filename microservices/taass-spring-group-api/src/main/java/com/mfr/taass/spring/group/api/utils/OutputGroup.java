...
public class OutputGroup {
    ...
    public List<InputAccount> getAccounts() {
        return accounts;
    }

    public void setAccounts(List<InputAccount> accounts) {
    ...
    private static InputAccount buildFromAccount(Account account){
        InputAccount in=new InputAccount();
