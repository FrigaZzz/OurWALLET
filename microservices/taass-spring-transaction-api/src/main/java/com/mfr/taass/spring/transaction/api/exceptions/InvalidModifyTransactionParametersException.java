 ...
 * @author Luca
 */
public class InvalidModifyTransactionParametersException extends Exception {
    private final InputTransaction providedTransaction;

    public InvalidModifyTransactionParametersException(InputTransaction providedTransaction) {
