 ...
 * @author Luca
 */
public class InvalidAddTransactionParametersException extends Exception {
    private final InputTransaction providedTransaction;

    public InvalidAddTransactionParametersException(InputTransaction providedTransaction) {
